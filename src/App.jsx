  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route
          path="/user"
          element={userDetails ? <UserHome /> : <Navigate to="/user/login" />}
        />
        <Route
          path="/user/register"
          element={!userDetails ? <UserSignup /> : <Navigate to="/user" />}
        />
        <Route
          path="/user/login"
          element={!userDetails ? <UserLogin /> : <Navigate to="/user" />}
        />
        <Route
          path="/user/propertyDetails"
          element={
            userDetails ? <PropertyDetails /> : <Navigate to="/user/login" />
          }
        />
